      ...
      <div style={{ maxWidth: 1680, margin: "0 auto", display: "grid", gap: 16 }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "end", gap: 16, flexWrap: "wrap" }}>
          ...
          <div style={{ display: "flex", gap: 8, flexWrap: "wrap", alignItems: "center" }}>
            ...
            <button type="button" onClick={() => setIsSetupCollapsed((prev) => !prev)} style={baseButton("outline")}>
              {isSetupCollapsed ? "Show setup" : "Hide setup"}
            </button>
          </div>
        </div>
        ...
        <div style={{ display: "grid", gap: 16, gridTemplateColumns: isSetupCollapsed ? "1fr" : "minmax(320px,390px) minmax(0,1fr)", alignItems: "start" }}>
          ...
          <div style={{ display: "grid", gap: 16, gridTemplateColumns: "minmax(0,1.65fr) minmax(320px,1fr)", alignItems: "start" }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr", gap: 12 }}>
              <div style={{ ...card(), padding: 10, display: "flex", gap: 8, flexWrap: "wrap" }}>
                <button type="button" onClick={() => setActiveWorkspaceTab("race")} style={baseButton(activeWorkspaceTab === "race" ? "secondary" : "outline")}>Race</button>
                <button type="button" onClick={() => setActiveWorkspaceTab("results")} style={baseButton(activeWorkspaceTab === "results" ? "secondary" : "outline")}>Results</button>
                <button type="button" onClick={() => setActiveWorkspaceTab("tournament")} style={baseButton(activeWorkspaceTab === "tournament" ? "secondary" : "outline")}>Tournament</button>
              </div>
